return function (vim)
  ...
  require('gitsigns').setup {
    on_attach = function(_)
      ...
      map('v', '<leader>gs', function() gs.stage_hunk { vim.fn.line('.'), vim.fn.line('v') } end, d("stage hunk"))
      map('v', '<leader>gr', function() gs.reset_hunk { vim.fn.line('.'), vim.fn.line('v') } end, d("reset hunk"))
      ...
      map('n', '<leader>gb', function() gs.blame_line { full = true } end, d("blame line"))
